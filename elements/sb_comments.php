...
<div id="editComment_<?php echo $gbx_prefix.$comments[$i]['commentID']?>" class="editComment hide">


		<div class="input-prepend input-append">
		<span class="add-on"><i class="icon-comment"></i></span>
		<input type="text" class="span8" name="comment-edit" id="comment-edit_<?php echo $gbx_prefix.$comments[$i]['commentID']?>" value="<?php echo $comments[$i]['commentText']?>"/>
    <input type="hidden" id="commpID_<?php echo $gbx_prefix.$comments[$i]['commentID']?>" name="commpID_<?php echo $gbx_prefix.$comments[$i]['commentID']?>" value="<?php  echo $pID?>"/>

		<button type="submit" name="submit" class="btn btn-success cws-comment-update-btn" data-placement="bottom" title="<?php echo t('save')?>" id="post-comment-edit_<?php echo $gbx_prefix.$comments[$i]['commentID']?>"><i class="icon-white icon-ok-circle"></i></button>
